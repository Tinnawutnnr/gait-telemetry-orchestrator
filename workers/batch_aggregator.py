...
from sqlalchemy import Integer, cast, create_engine, delete, func, select
from sqlalchemy.orm import sessionmaker

from app.models.orm import DailyAverage, WindowReport
    ...
    with SessionLocal() as db:
        try:
            stmt = (
                ...
                .where(func.date(WindowReport.timestamp) == yesterday, WindowReport.status == "MONITORING")
            ...
            # ==========================================
            del_stmt = delete(WindowReport).where(func.date(WindowReport.timestamp) < cutoff_date)
